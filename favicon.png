  ...
  carta: [
    ...
    { col:1, t:{es:"Para compartir", en:"To share"},
      items:[
        ...
        {es:"Tabla de quesos by Z", en:"Cheese board by Z", price:"18", desc:{es:"Selección de quesos con sus acompañamientos", en:"A selection of cheeses with garnishes"}, al:["lacteos"]},
        ...
        {es:"Calamar nacional a la andaluza", en:"Andalusian-style fried squid", price:"21", desc:{es:"Rebozado ligero y bien frito", en:"Lightly battered and crisp-fried"}, al:["moluscos","gluten"]},
        {es:"Calamar nacional a la plancha", en:"Grilled squid", price:"24", desc:{es:"Corte japonés (ikayaki), muy tierno", en:"Japanese cut (ikayaki), very tender"}, al:["moluscos"]},
        ...
        {es:"Zamburiña a la plancha", en:"Grilled queen scallop", price:"3,50", unit:{es:"ud", en:"each"}, desc:{es:"A la plancha, en su jugo", en:"Griddled, in its own juices"}, al:["moluscos"]},
        ...
        {es:"Flor de alcachofa con escalopa de foie", en:"Artichoke heart with foie escalope", price:"8", desc:{es:"Alcachofa confitada con escalopa de foie, uno de los favoritos de la casa", en:"Confit artichoke with foie escalope, a house favourite"}, al:["gluten","sulfitos"]},
      ]},
    ...
    { col:2, t:{es:"Carnes", en:"Meats"},
      items:[
        ...
        {es:"Presa ibérica 100% · Beher", en:"100% Iberian presa · Beher", price:"22,50", desc:{es:"Jugosa y veteada", en:"Juicy and beautifully marbled"}, al:[]},
        {es:"Entrecot de ternera", en:"Beef entrecôte", price:"24", desc:{es:"Lomo bajo de frisona, bien sabroso", en:"Friesian sirloin, full of flavour"}, al:[]},
        {es:"Chuleta de vaca vieja · 500 g · maduración +30 días", en:"Aged beef chop · 500 g · 30+ days", price:"35", desc:{es:"Maduración +30 días, intensa, para los más carnívoros", en:"30+ days aged, intense, for true meat lovers"}, al:[]},
      ]},
    ...
    { col:2, t:{es:"Los postres", en:"Desserts"},
      items:[
        ...
        {es:"Crema del chef", en:"Chef’s cream", price:"6,50", desc:{es:"Postre de cuchara, el secreto del chef y el más aplaudido", en:"The chef's secret spoon dessert, the most applauded"}, al:["lacteos","huevos"]},
  ...
  vinos: [
    { col:1, t:{es:"Blancos", en:"White"},
      items:[
        ...
        {es:"Mar de Frades Godello", en:"Mar de Frades Godello", img:"assets/vinos/marfrades-godello.png", desc:{es:"Godello · Rías Baixas", en:"Godello · Rías Baixas"}, price:"30"},
